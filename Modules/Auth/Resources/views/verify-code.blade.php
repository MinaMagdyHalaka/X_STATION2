            ...
            <table width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                <tr>
                    <td align="center" style="padding: 40px 20px;">
                        ...
                        <p style="color: #666666; line-height: 1.6;">You are receiving this email because we received a verification code request for your account.</p>
                        <p style="color: #666666; line-height: 1.6;">If you did not request a verification code, no further action is required.</p>
